export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	raichu: {
		...
		eggGroups: ["Field", "Fairy"],
		otherFormes: ["Raichu-Alola", "Raichu-Mega-X", "Raichu-Mega-Y","Raichu-Zeta"],
		formeOrder: ["Raichu", "Raichu-Alola", "Raichu-Mega-X", "Raichu-Mega-Y","Raichu-Zeta"],
	},
	raichualola: {
		num: 26,
		name: "Raichu-Alola",
	...
	raichuzeta: {
		...
		forme: "Zeta",
		types: ["Electric", "Poison"],
		baseStats: { hp: 60, atk: 105, def: 55, spa: 80, spd: 80, spe: 100 },
		abilities: { 0: "Poison Touch", H: "Poison Point" },
		heightm: 0.7,
		weightkg: 21,
		color: "Brown",
	...
	paraszeta: {
		...
		types: ["Bug", "Psychic"],
		gender: "N",
		baseStats: { hp: 55, atk: 45, def: 80, spa: 70, spd: 55, spe: 25 },
		abilities: { 0: "Strange Presence", H: "Neuroforce" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Purple",
		tags: ["Mythical"],
	...
	parasect: {
		...
		evoLevel: 24,
		eggGroups: ["Bug", "Grass"],
		otherFormes: ["Parasect-Zeta"],
		formeOrder: ["Parasect", "Parasect-Zeta"],
	},
	parasectzeta: {
		num: 47,
		name: "Parasect-Zeta",
		...
		types: ["Bug", "Psychic"],
		gender: "N",
		baseStats: { hp: 70, atk: 60, def: 80, spa: 95, spd: 80, spe: 30 }, //+10hp, -35atk, +35spa
		abilities: { 0: "Strange Presence", H: "Neuroforce" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Purple",
	...
	cubone: {
		...
		eggGroups: ["Monster"],
		otherFormes: ["Cubone-Zeta"],
		formeOrder: ["Cubone", "Cubone-Zeta"],
	},
	cubonezeta: {
		num: 105,
		name: "Cubone-Zeta",
	...
	marowak: {
		...
		evoLevel: 28,
		eggGroups: ["Monster"],
		otherFormes: ["Marowak-Alola", "Marowak-Alola-Totem", "Marowak-Zeta"],
		formeOrder: ["Marowak", "Marowak-Alola", "Marowak-Alola-Totem", "Marowak-Zeta"],
	},
	marowakalola: {
		num: 105,
		name: "Marowak-Alola",
	...
	marowakzeta: {
		...
		forme: "Zeta",
		types: ["Ground", "Steel"],
		baseStats: { hp: 60, atk: 80, def: 100, spa: 45, spd: 50, spe: 70 },
		abilities: { 0: "Rock Head", 1: "Sheer Force", H: "Battle Armor" },
		heightm: 1,
		weightkg: 34,
		color: "Purple",
		prevo: "Cubone",
	...
	porygon: {
		...
		evos: ["Porygon2"],
		eggGroups: ["Mineral"],
		otherFormes: ["Porygon-Zeta"],
		formeOrder: ["Porygon", "Porygon-Zeta"],
	},
	porygonzeta: {
		num: 137,
		name: "Porygon-Zeta",
		...
		gender: "N",
		baseStats: { hp: 65, atk: 60, def: 65, spa: 75, spd: 80, spe: 40 },
		abilities: { 0: "Trace", 1: "Download", H: "Analytic" },
		heightm: 0.8,
		weightkg: 36.5,
		color: "Brown",
	...
	porygon2: {
		...
		evos: ["Porygon-Z"],
		eggGroups: ["Mineral"],
		otherFormes: ["Porygon2-Zeta"],
		formeOrder: ["Porygon2", "Porygon2-Zeta"],
	},
	porygon2zeta: {
		num: 233,
		name: "Porygon2-Zeta",
	...
	sceptilemega: {
		...
		types: ["Grass", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 130, def: 75, spa: 125, spd: 85, spe: 145 }, //+10hp +20atk -20spa
		abilities: { 0: "Lightning Rod" },
		heightm: 1.9,
		weightkg: 55.2,
		color: "Green",
	...
	wailmer: {
		...
		otherFormes: ["Wailmer-Zeta"],
		formeOrder: ["Wailmer", "Wailmer-Zeta"],
	},
	wailmerzeta: {
		num: 320,
		name: "Wailmer-Zeta",
		...
		abilities: { 0: "Unburden", 1: "Aerilate", H: "Flare Boost" },
		heightm: 2,
		weightkg: 130,	
		color: "Blue",
		eggGroups: ["Field", "Water 2"],
	...
	wailord: {
		...
		evoLevel: 40,
		eggGroups: ["Field", "Water 2"],
		otherFormes: ["Wailord-Zeta"],
		formeOrder: ["Wailord", "Wailord-Zeta"],
	},
	wailordzeta: {		
		num: 320,
		name: "Wailord-Zeta",
		...
		forme: "Zeta",
		types: ["Water", "Flying"],
		baseStats: { hp: 170, atk: 90, def: 55, spa: 90, spd: 55, spe: 60 },
		abilities: { 0: "Unburden", 1: "Aerilate", H: "Flare Boost" },
		heightm: 14.5,
		weightkg: 398,	
		color: "Blue",
	...
	cameruptmega: {
		...
		forme: "Mega",
		types: ["Fire", "Ground"],
		baseStats: { hp: 70, atk: 120, def: 110, spa: 150, spd: 115, spe: 20 },
	...
	vibrava: {
		...
		evos: ["Flygon"],
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Vibrava-Zeta"],
		formeOrder: ["Vibrava", "Vibrava-Zeta"],
	},
	vibravazeta: {
		num: 329,
		name: "Vibrava-Zeta",
	...
	flygon: {
		...
		evoLevel: 45,
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Flygon-Zeta"],
		formeOrder: ["Flygon", "Flygon-Zeta"],
	},
	flygonzeta: {
		num: 330,
		name: "Flygon-Zeta",
	...
	bidoof: {
		...
		evos: ["Bibarel"],
		eggGroups: ["Water 1", "Field"],
		otherFormes: ["Bidoof-Zeta"],
		formeOrder: ["Bidoof", "Bidoof-Zeta"],
	},
	bidoofzeta: {
		num: 399,
		name: "Bidoof-Zeta",
	...
	bibarel: {
		...
		evoLevel: 15,
		eggGroups: ["Water 1", "Field"],
		otherFormes: ["Bibarel-Zeta"],
		formeOrder: ["Bibarel", "Bibarel-Zeta"],
	},
	bibarelzeta: {
		num: 400,
		name: "Bibarel-Zeta",
		...
		abilities: { 0: "Simple", 1: "Thick Fat", H: "Fluffy" },
		heightm: 1,
		weightkg: 31.5,
		color: "White",
		eggGroups: ["Water 1", "Field"],
	...
	kricketunezeta: {
		...
		abilities: { 0: "Contraguardia", H: "Sharpness" },
		heightm: 1,
		weightkg: 25.5,
		color: "Red",		
		eggGroups: ["Bug"],
	...
	porygonz: {
		...
		eggGroups: ["Mineral"],
		otherFormes: ["Porygon-Z-Zeta"],
		formeOrder: ["Porygon-Z", "Porygon-Z-Zeta"],
	},
	porygonzzeta: {
		num: 474,
		name: "Porygon-Z-Zeta",
	...
	froslassmega: {
		...
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: { hp: 70, atk: 80, def: 70, spa: 150, spd: 100, spe: 120 },
		abilities: { 0: "Snow Warning" },
		heightm: 2.6,
		weightkg: 29.6,
		color: "White",
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow","Rotom-Zeta"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Zeta"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
	...
	rotomzeta: {
		...
		types: ["Electric", "Dark"],
		gender: "N",
		baseStats: { hp: 80, atk: 105, def: 107, spa: 65, spd: 107, spe: 86 },
		abilities: { 0: "Levitate" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	lilligant: {
		...
		evoItem: "Sun Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Lilligant-Hisui", "Lilligant-Zeta"],
		formeOrder: ["Lilligant", "Lilligant-Hisui", "Lilligant-Zeta"],
	},
	lilliganthisui: {
		num: 549,
	...
	lilligantzeta: {
		...
		gender: "F",
		baseStats: { hp: 70, atk: 60, def: 75, spa: 110, spd: 75, spe: 90 },
		abilities: { 0: "Despierta Llama", H: "Flame Body" },
		heightm: 1.2,
		weightkg: 19.2,
		color: "Green",
		prevo: "Petilil",
	...
	yamask: {
		...
		otherFormes: ["Yamask-Galar", "Yamask-Zeta"],
		formeOrder: ["Yamask", "Yamask-Galar", "Yamask-Zeta"],
	},
	yamaskgalar: {
		num: 562,
		name: "Yamask-Galar",
	...
	cofagrigus: {
		...
		evoLevel: 34,
		eggGroups: ["Mineral", "Amorphous"],
		otherFormes: ["Cofagrigus-Zeta"],
		formeOrder: ["Cofagrigus", "Cofagrigus-Zeta"],
	},
	cofagriguszeta: {
		num: 563,
		name: "Cofagrigus-Zeta",
		baseSpecies: "Cofagrigus",
		forme: "Zeta",
		types: ["Ghost", "Steel"],
		baseStats: { hp: 58, atk: 80, def: 145, spa: 65, spd: 105, spe: 30 },
	...
	garbodor: {
		...
		name: "Garbodor",
		types: ["Poison", "Steel"],
		baseStats: { hp: 100, atk: 95, def: 82, spa: 85, spd: 82, spe: 55 },  //+20hp, +25spa, -20spe
	...
	gothitelle: {
		...
		evoLevel: 41,
		eggGroups: ["Human-Like"],
		otherFormes: ["Gothitelle-Zeta"],
		formeOrder: ["Gothitelle", "Gothitelle-Zeta"],
	},
	gothitellezeta: {
		num: 576,
		name: "Gothitelle-Zeta",
		baseSpecies: "Gothitelle",
		forme: "Zeta",
		types: ["Ghost", "Fire"],
		baseStats: { hp: 70, atk: 55, def: 95, spa: 95, spd: 110, spe: 65 },
		abilities: { 0: "Flame Body", H: "Espanto" },
		heightm: 1.5,
		weightkg: 44,
		color: "Red",
		eggGroups: ["Human-Like"],
	...
	golurkmega: {
		...
		types: ["Ground", "Ghost"],
		gender: "N",
		baseStats: { hp: 94, atk: 159, def: 110, spa: 70, spd: 105, spe: 55 },
	...
	chesnaught: {
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Chesnaught-Mega", "Chesnaught-Zeta"],
		formeOrder: ["Chesnaught", "Chesnaught-Mega", "Chesnaught-Zeta"],
	},
	chesnaughtmega: {
		num: 652,
	...
	delphox: {
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Delphox-Mega", "Delphox-Zeta"],
		formeOrder: ["Delphox", "Delphox-Mega", "Delphox-Zeta"],
	},
	delphoxmega: {
		num: 655,
		name: "Delphox-Mega",
	...
	delphoxzeta: {
		...
		abilities: { 0: "Blaze", H: "Relampagueo" },
		heightm: 1.5,
		weightkg: 39,
		color: "Red",
		prevo: "Braixen",
	...
	greninja: {
		...
		evoLevel: 36,
		eggGroups: ["Water 1"],
		otherFormes: ["Greninja-Bond", "Greninja-Ash", "Greninja-Mega", "Greninja-Zeta", "Greninja-Zeta-Ilusorio"],
		formeOrder: ["Greninja", "Greninja-Bond", "Greninja-Ash", "Greninja-Mega", "Greninja-Zeta", "Greninja-Zeta-Ilusorio"],
	},
	greninjabond: {
		num: 658,
		name: "Greninja-Bond",
	...
	greninjazeta: {
		...
		abilities: { 0: "Torrent", H: "Forma Ilusoria" },
		heightm: 1.5,
		weightkg: 80,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	greninjazetailusorio: {
		num: 658,
		name: "Greninja-Zeta-Ilusorio",
		baseSpecies: "Greninja",
		forme: "Zeta-Ilusiorio",
		types: ["Water", "Psychic"],
		gender: "M",
		baseStats: { hp: 107, atk: 75, def: 86, spa: 122, spd: 93, spe: 62 },
		abilities: { 0: "Torrent", H: "Forma Ilusoria" },
	...
	royaleon: {
		...
		abilities: { 0: "Realeza", H: "Fur Coat" },
		heightm: 0.9,
		weightkg: 25,
		color: "Gray",
		prevo: "Eevee",
	...
	constellarlunar: {
		num: 2004,
		name: "Constellar-Lunar",
		baseSpecies: "Constellar",
		forme: "Zeta",
		types: ["Rock", "Psychic"],  
		gender: "M",
	...
	fobeto: {
		...
		abilities: { 0: "Gran Pesadilla", 1: "Espanto"},
		heightm: 1.9,
		weightkg: 91.6,
		color: "Purple",
		prevo: "Hypno",
	...
	serdupla: {
		...
		abilities: { 0: "Merciless", 1: "Parental Bond", H: "Shed skin" },
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field", "Dragon"],
